...
fun AppCompatActivity.validateForm(
    ...
    when {
        fields.contains("") -> Toast.makeText(this,
            R.string.empty_fields, Toast.LENGTH_SHORT).show()
        fields[0].length < 5 -> Toast.makeText(this,
            R.string.placa_min_size, Toast.LENGTH_SHORT).show()
        fields[0].length > 6 -> Toast.makeText(this,
            R.string.placa_max_size, Toast.LENGTH_SHORT).show()
